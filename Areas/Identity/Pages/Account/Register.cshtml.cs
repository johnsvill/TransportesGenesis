    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // 🔑 Inicializamos el flag de primer login
        ...
        private AppUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"No se puede crear una instancia de '{nameof(AppUser)}'. " +
                    $"Asegúrate de que '{nameof(AppUser)}' no sea abstracta y tenga un constructor sin parámetros.");
            }
        }
        ...
        private IUserEmailStore<AppUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("El UI por defecto requiere un store con soporte de email.");
            }
