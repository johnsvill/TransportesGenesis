...
namespace TransportesGenesis.Migrations
{
    ...
    [Migration("20260517211648_SyncIdentity")]
    partial class SyncIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportesGenesis.Models.DB.Negocio.AlertaProximidad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ConfirmacionPadre")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.Property<DateTime?>("FechaConfirmacionPadre")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ParadaActual")
                        .HasMaxLength(200)
                    ...
                    b.Property<int?>("ParadasRestantes")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdBus", "Estado");

                    b.ToTable("AlertasProximidad", "genesis", t =>
                        {
                            t.HasCheckConstraint("CK_AlertaProximidad_Estado", "[Estado] IN ('activo', 'resuelto')");

                            t.HasCheckConstraint("CK_AlertaProximidad_TipoAlerta", "[TipoAlerta] IN ('proximidad', 'retraso')");
                        });
                });
            ...
            modelBuilder.Entity("TransportesGenesis.Models.DB.Negocio.AsistenciaAlumno", b =>
                {
                    ...
                    b.HasIndex("IdBusTemporalMañana");

                    b.HasIndex("IdBusTemporalTarde");
            ...
            modelBuilder.Entity("TransportesGenesis.Models.DB.Negocio.ConfiguracionSistema", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TransportesGenesis.Models.DB.Usuarios.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TransportesGenesis.Models.DB.Negocio.Alumnos", b =>
                {
                    ...
                    b.HasOne("TransportesGenesis.Models.DB.Negocio.Bus", "BusAsignado")
                        .WithMany()
                        .HasForeignKey("IdBusAsignado")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("TransportesGenesis.Models.DB.Negocio.AsistenciaAlumno", b =>
                {
                    ...
                    b.HasOne("TransportesGenesis.Models.DB.Negocio.Bus", "BusTemporalMañana")
                        .WithMany()
                        .HasForeignKey("IdBusTemporalMañana")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TransportesGenesis.Models.DB.Negocio.Bus", "BusTemporalTarde")
                        .WithMany()
                        .HasForeignKey("IdBusTemporalTarde")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Alumno");

                    b.Navigation("BusTemporalMañana");

                    b.Navigation("BusTemporalTarde");
                });
            ...
            modelBuilder.Entity("TransportesGenesis.Models.DB.Negocio.SolicitudTraslado", b =>
                {
                    ...
                    b.HasOne("TransportesGenesis.Models.DB.Negocio.Bus", "BusDestino")
                        .WithMany()
                        .HasForeignKey("IdBusDestino");
